...
class _FakeClassifier:
    def classify(self, caption: str) -> str:
        return "C04_generic_subject_object" if "girl" in caption else "C05_scene_decor_container"
...
def test_reports_mismatches():
    ...
    assert report["by_expected_group"]["C03_irreplaceable_entity_event_action"]["mismatch_count"] == 1
...
def test_classifier_can_return_payload_dict_and_uses_legacy_fallback():
    class PayloadClassifier:
        def classify(self, caption: str) -> dict:
            ...
            return {"strict_reuse_group": "C05_scene_decor_container"}
