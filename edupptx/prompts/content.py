...
- 10 页以上的演示文稿必须包含至少 1 个 section（章节过渡页）
- 10 页以上必须包含至少 1 个 big_quote（名人名言或关键观点）
- 有实验、场景、具象概念的页面，优先使用 image_left 或 image_right 而非 content
- full_image 适合展示关键实验装置或科学现象的页面
- 避免连续 3 页以上使用相同布局类型
